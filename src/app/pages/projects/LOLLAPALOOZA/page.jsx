...
export default function LollaProject() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-white p-8" style={{ backgroundImage: `url('/img/fundo/fundololla.png')`, backgroundSize: 'cover' }}>
            ...
            <h1 className="text-4xl font-bold mb-4 text-center text-black">🎉 Bradesco no Lollapalooza 2025 </h1>
            ...
            <Link href="https://www.linkedin.com/posts/j%C3%BAlia-lopes-coimbra-12648624a_lollapalooza2025-bradesco-inovaaexaeto-activity-7318316310226964480-VapJ?utm_source=share&utm_medium=member_desktop&rcm=ACoAAD2mgS4BRf3m3xosS8VNhs4dsdmk5Ia9BZw" target="_blank">
