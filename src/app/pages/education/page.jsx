  ...
  return (
    <div className="bg-gray-100  sm:py-8">
      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <div
          className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2 relative bg-cover bg-center pt-10  pl-10"
          style={{ backgroundImage: "url('/img/escola.jpg')" }}
        >
          <div className="absolute inset-0 bg-gray-900/50 rounded-2xl"></div>

          <div className="relative max-lg:row-start-1">
            <div className="absolute inset-px rounded-lg bg-gray-400 bg-opacity-60 max-lg:rounded-t-[2rem]"></div>
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-1">
            <div className="absolute inset-px rounded-lg bg-gray-400 bg-opacity-60"></div>
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
              <div className="px-8 pt-5 sm:px-10 sm:pt-5 text-white">
                <p className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">
          ...
          <div className="relative lg:row-span-2">
            <div className="absolute inset-px rounded-lg bg-gray-400 bg-opacity-60 max-lg:rounded-b-[2rem] lg:rounded-r-[2rem]"></div>
